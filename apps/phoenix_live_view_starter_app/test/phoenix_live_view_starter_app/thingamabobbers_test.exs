defmodule PhoenixLiveViewStarterApp.ThingamabobbersTest do
  use PhoenixLiveViewStarterApp.DataCase
  ...
  describe "things" do
    ...
    test "create_thing/1 with valid data creates a thing" do
      ...
      assert thing.amount == Decimal.new("120.50")
      assert thing.data == %{}
    ...
    test "update_thing/2 with valid data updates the thing" do
      ...
      assert thing.amount == Decimal.new("456.70")
      assert thing.data == %{}
